# brownie run scripts/whitelist-gauges-2023-07-11.py --network mainnet-fork
...
def main():
    ...
    # config
    gauges = ["0x37Aba96BAEA0e82487A46D1916271c9fdC8D35d9", "0x79DE2381b7181178555905319db7dA8a1Af72645"]
