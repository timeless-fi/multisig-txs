# brownie run scripts/whitelist-gauges-2023-05-29.py --network mainnet-fork
...
def main():
    ...
    # config
    gauges = ["0xA1A4BAb0768A089f633Fcb196D428001D2C4Fe6a", "0x53F36500141765f74E4745aCd7195d12a2DA6f42"]
